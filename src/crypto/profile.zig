...
pub const rows = [_]Row{
    ...
    row(.{ .signature = .rsa_pss_rsae_sha256 }, "RSA-PSS-RSAE-SHA256", .project_code, .supported, .openssl_provider, .provider_deferred, "strict DER/RSA-PSS positive and negative fixtures", .{ .tls_handshake, .pki }, "Pure-Zig verifier validates the complete EMSA-PSS encoding and constrained RSA public keys."),
