...
pub const rows = [_]Row{
    ...
    row(.{ .signature = .rsa_pss_rsae_sha256 }, "RSA-PSS-RSAE-SHA256", .zig_std_crypto, .supported, .openssl_provider, .provider_deferred, "PSS verify across 2048/3072/4096-bit moduli, tamper, bad-parameter rejection (#343)", .{ .tls_handshake, .pki }, "Verification only; RSA-PSS signing remains provider-deferred."),
