...
//! - `certificate_policies` — bounded RFC 9618 policy-graph processing
//!
//! ## Policy summary
//!
...
pub const certificate_policies = @import("certificate_policies.zig");
...
test {
    ...
    _ = @import("certificate_policies_tests.zig");
}
